                            ...
                            <form action="{{ route('admin.testimonial.title.update') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ @$titles['testimonial_top_title'] }}" name="testimonial_top_title"
                                        id="">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ @$titles['testimonial_main_title'] }}" name="testimonial_main_title"
                                        id="">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ @$titles['testimonial_sub_title'] }}" name="testimonial_sub_title"
                                        id="">
                                </div>
