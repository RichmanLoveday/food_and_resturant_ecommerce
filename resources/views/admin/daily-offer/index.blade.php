                            ...
                            <form action="{{ route('admin.daily-offer.title.update') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ @$titles['daily_offer_top_title'] }}" name="daily_offer_top_title"
                                        id="">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ @$titles['daily_offer_main_title'] }}" name="daily_offer_main_title"
                                        id="">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ @$titles['daily_offer_sub_title'] }}" name="daily_offer_sub_title"
                                        id="">
                                </div>
