        ...
        <div class="section-body">
            <div class="invoice">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <strong>First Name:</strong> {!! @$order->userAddress?->first_name !!} <br>
                                        <strong>Last Name:</strong> {!! @$order->userAddress?->last_name !!} <br>
                                ...
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    @foreach ($order->orderItems as $orderItem)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ @$size->name }}
                                                ({{ isset($size->price) ? currencyPosition($size->price) : '' }})
                                                <br>
                                                options:
                                        ...
                                        <form action="{{ route('admin.orders.status-update', $order->id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="payment_status" id="">
                                                    <option name="" id="" @selected($order->payment_status === 'pending')
                                                        value="pending">Pending</option>
                                                    <option name="" id="" @selected($order->payment_status === 'completed')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="order_status" id="">
                                                    <option name="" id="" @selected($order->order_status === 'pending')
                                                        value="pending">Pending
                                                    </option>
                                                    <option name="" id="" @selected($order->order_status === 'in_process')
                                                        value="in_process">In Process
                                                    </option>
                                                    <option name="" id="" @selected($order->order_status === 'delivered')
                                                        value="delivered">Delivered
                                                    </option>
                                                    <option name="" id="" @selected($order->order_status === 'declined')
                ...
                <div class="text-md-right">
                    <button id="print_btn" class="btn btn-warning btn-icon icon-left"><i class="fas fa-print"></i>
                        Print</button>
                </div>
            </div>
        </div>
