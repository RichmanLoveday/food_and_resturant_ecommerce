                         ...
                         <div class="fp__single_blog">
                             ...
                             <div class="fp__single_blog_text">
                                 ...
                                 <ul class="d-flex flex-wrap mt_15">
                                     <li><i class="fas fa-user"></i>{{ \Str::ucfirst($blog->user->name) }}</li>
                                     <li><i class="fas fa-calendar-alt"></i>
                                         {{ \Carbon\Carbon::parse($blog->created_at)->format('j F Y') }}</li>
                                     <li><i class="fas fa-comments"></i> {{ $blog->comments_count }} comment</li>
                                 </ul>
                                 <a class="title"
                                     href="{{ route('blog-details', $blog->slug) }}">{{ truncate($blog->title, 30) }}</a>
                             </div>
                         </div>
                     </div>
                 @endforeach
