         ...
         @foreach ($orders as $order)
             <div class="fp__invoice invoice_details_{{ $order->id }}">
                 ...
                 <div class="fp__track_order d-print-none">
                     <ul>
                         <li
                             class="{{ in_array($order->order_status, ['pending', 'in_process', 'delivered', 'declined']) ? 'active' : '' }} ">
                             order pending</li>
                         <li
                         ...
                         @if ($order->order_status === 'declined')
                             <li class="{{ in_array($order->order_status, ['declined']) ? 'declined_status' : '' }} ">
                                 order declined
                             </li>
                         @else
                 ...
                 <div class="fp__invoice_header">
                     ...
                     <div class="header_address">
                         ...
                         <p><b style="width: 140px;">Payment Status:</b> <span> {{ @$order->payment_status }}</span>
                         </p>
                         ...
                         <table class="table table-striped">
                             <tbody>
                                 ...
                                 @foreach ($order->orderItems as $orderItem)
                                     ...
                                     <td class="price">
                                         <b>{{ currencyPosition($unitPrice) }}</b>
                                     </td>
                                     <td class="qnty">
                                         <b>{{ $qty }}</b>
                                     </td>
